...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e8tixmw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e8tixmw.containers.anotherwebservice.com/
...
```
git clone git@github.com:geneross/container-e8tixmw.git
cd container-e8tixmw
```
...
```
docker attach container-e8tixmw
```
